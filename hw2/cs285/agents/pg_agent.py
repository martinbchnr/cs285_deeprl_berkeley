...
class PGAgent(BaseAgent):
    ...
    def _discounted_return(self, rewards):
        ...
        discounted_rewards = [discounts[i]*rewards[i] for i in range(len(rewards))]
        ...
        list_of_discounted_returns = [sum_of_discounted_rewards for i in range(len(rewards))]
    ...
    def _discounted_cumsum(self, rewards):
        ...
        for start_time_index in range(len(rewards)): 
            ...
            indices = [t for t in range(start_time_index,len(rewards))]

            
            # 2) create a list where the entry at each index (t') is gamma^(t'-t)
            discounts = [self.gamma**(t-start_time_index) for t in range(start_time_index,len(rewards))]
            ...
            #print(range(start_time_index,len(rewards)))
